...
@Controller @RequestMapping("/unidades") @RequiredArgsConstructor
public class UnidadeController {
    private final UnidadeService service;
    @GetMapping public String list(Model m) { m.addAttribute("unidades", service.findAll()); return "unidades/list"; }
    @GetMapping("/new") public String newForm(Model m) { m.addAttribute("unidade", new Unidade()); return "unidades/form"; }
    @GetMapping("/{id}/edit") public String editForm(@PathVariable Long id, Model m) { m.addAttribute("unidade", service.findById(id)); return "unidades/form"; }
    @PostMapping
