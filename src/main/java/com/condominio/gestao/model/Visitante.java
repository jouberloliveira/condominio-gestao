...
import com.condominio.gestao.enums.TipoVisitante;
...
public class Visitante {
    ...
    @Column(nullable = false)
    private TipoVisitante tipoVisitante = TipoVisitante.VISITA;
    ...
    public Morador getAutorizadoPor() {
        return autorizadoPor;
    }

    public void setAutorizadoPor(Morador autorizadoPor) {
